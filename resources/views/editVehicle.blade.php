...
<div class="p-4 col-sm-3 py-20" style="border-right: 2px solid #b1d1ea">
        ...
        <nav class="nav nav-tabs flex-column">
            ...
            <!-- <br>
            <a href="/vehicle/edit" class="nav-item nav-link active">
            ...
            <div class="container">
                    ...
                    <form method="POST" action="/vehicle/{{ $vehicle->id }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number_plate" type="text" class="form-control @error('number_plate') is-invalid @enderror"  value="{{ $vehicle->number_plate }}" name="number_plate" required autocomplete="number_plate" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="brand" type="text" class="form-control @error('brand') is-invalid @enderror" value="{{ $vehicle->brand }}" name="brand" required autocomplete="brand">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="model" type="text" class="form-control @error('model') is-invalid @enderror"  value="{{ $vehicle->model }}" name="model" required autocomplete="model">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="color" type="color" class="form-control @error('color') is-invalid @enderror"  value="{{ $vehicle->color }}" name="color" required autocomplete="color">
